...
export default function UpperNav({ isSeller = false }) {
    ...
    <div className="tn-uppernav">
      <div className="tn-uppernav-wrapper px-2 px-md-4">
        ...
        <div className="tn-left-icons">
          <span className="tn-lang-btn tn-visible-mobile">
            EN <i className="fa fa-exchange"></i>
          </span>

          <i className="fa fa-bell tn-nav-icon tn-hidden-mobile"></i>
          <svg
            width="40"
            height="40"
            viewBox="0 0 50 50"
            ...
            className="tn-cart-icon tn-visible-mobile"
          >
            <path
          ...
          <Link to={"/profileaccount"} className="tn-profile-link tn-visible-mobile">
