...
{ path: 'sellerlayout', element: <SellerLayout /> },
{ path: 'sellerlogin', element: <SellerLogin /> },
{ path: 'sellerneworders2', element: <SellerNewOrders2 /> },
{ path: 'sellernewordersdetails', element: <SellerNewordersDetails /> },
{ path: 'sellerchangepassword', element: <SellerChangePassword /> },
{ path: 'sellerforgetpassword', element: <SellerForgetPassword /> },
{ path: 'sellerresetpassword', element: <SellerResetPassword /> },
{ path: 'sellerregister', element: <Sellerregister /> },
{ path: 'selleraccounttype', element: <SellerAccountType /> },
{ path: 'sellerselleradmin', element: <SellerAdmin /> },
{ path: 'sellerservices', element: <SellerServices /> },
{ path: 'sellerrelatedproducts', element: <SellerRelatedProducts /> },
{ path: 'sellerrelatedactivites', element: <SellerRelatedActivites /> },
{ path: 'sellersidebarfilters', element: <SellerSidebarFilters /> },
{ path: 'sellerproductlist', element: <SellerProductList /> },
{ path: 'sellerproductcard', element: <SellerProductCard /> },
{ path: 'sellerproductdetails', element: <SellerProductDetails /> },
{ path: 'sellercanceledorders', element: <SellerCanceledOrders /> },
{ path: 'sellermystore', element: <SellerMyStore /> },
{ path: 'sellerneworders', element: <SellerNewOrders /> },
{ path: 'sellercanceledordersdetails', element: <SellerCanceledOrdersDetails /> },
{ path: 'selleraddadvertisement', element: <SellerAddAdvertisement /> },
{ path: 'sellerfinancialreports', element: <SellerFinancialReports /> },
{ path: 'sellermysecondstore', element: <SellerMysecodStore /> },
{ path: 'selleradvertisementdetails', element: <SellerAddverisementDetails /> },
{ path: 'sellermyorders', element: <SellerMyOrders /> },
{ path: 'sellerconfirmedorders', element: <SellerConfirmedOrders /> },
{ path: 'sellerorderdetails', element: <SellerOrderDetails /> },
{ path: 'sellershippedorders', element: <SellerShippedOrders /> },
{ path: 'sellerordersdetails2', element: <SellerOrdersDetails2 /> },
{ path: 'sellermyemptydeiveredorders', element: <SellerMyemptydeiveredOrders /> },
{ path: 'sellermydeliveredorders', element: <SellerMydeliveredOrders /> },
{ path: 'sellermarketing', element: <SellerMarketing /> },
{ path: 'sellerprofileaccount', element: <SellerProfileAccount /> },
{ path: 'sellermarketingreferral', element: <SellerMarketingReferral /> },
{ path: 'sellerlogoutconfirm', element: <SellerLogoutConfirm /> },
{ path: 'sellercontractpage', element: <SellerContractPage /> },
{ path: 'sellersecondcontract', element: <SellerSecondContract /> },
{ path: 'sellerbankaccount', element: <SellerBankAccount /> },
{ path: 'selleremptyadvertisement', element: <SellerEmptyAdvertisement /> },
{ path: 'sellerchoosesupport', element: <SellerChooseSupport /> },

{ path: 'sellerproduct/:id', element: <SellerProductDetails /> },
{ path: 'sellermaddisupport', element: <SellerMaddiSupport /> },
{ path: 'selleraynisupport', element: <SellerAyniSupport /> },

{ path: 'sellermyorddetails', element: <SellerMyOrdDetails /> },
{ path: 'sellerfinancialdashboard', element: <SellerFinancialDashboard /> },
{ path: 'sellerproductsSection', element: <SellerProductsSection /> },
{ path: 'sellermorerelated', element: <SellerMoreRelated /> },
{ path: 'sellerabouttawq', element: <SellerAbouttawq /> },
    ],
    },
];
